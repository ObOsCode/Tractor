package models.devices.robots.platform;

import java.util.ArrayList;

import models.devices.robots.RobotDevice;
import models.devices.robots.RobotType;
import models.devices.robots.platform.events.ITractorListener;
import models.devices.robots.platform.events.ITractorPlatformDispatcher;
import models.devices.robots.platform.events.TractorPlatformEvent;
import ru.roboticsUMK.commandProtocol.deviceConnection.arduino.ArduinoDevice;

public class TractorPlatform extends RobotDevice implements ITractorPlatformDispatcher
{
...
//	private int _MAX_ROTATION_FREQUENCY = 2; //rot per second
	...
	public TractorPlatform(ArduinoDevice connection)
	{
		super(connection, RobotType.PLATFORM);
	}

...
import tractorPlatform.connections.serial.SerialPortManager;
import tractorPlatform.tractor.controllers.MainWindowController;
...
public class MainWindow
{
		...
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					...
					MainWindow window = new MainWindow(tractor);
					window._frame.setVisible(true);
					
					new MainWindowController(window, tractor);
	...
	public MainWindow(Tractor tractor)
	{
		_tractor = tractor;
